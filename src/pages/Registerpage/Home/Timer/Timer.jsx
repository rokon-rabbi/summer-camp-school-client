...
const Timer = () => {
  ...
  useEffect(() => {
    const countdownDate = new Date('2023-12-31T23:59:59'); // Set your desired countdown date and time
    ...
    return (
        <div>
                 <section className=" bg-[#FCC044] p-4 md:p-20">
      <div className="max-w-full md:flex justify-between mx-auto">
        <h2 > <span className="md:text-xl text-white  font-bold mb-4" >until first session</span >  <br /><span className="text-3xl font-bold  text-white   mb-4">Don’t Miss the First Day
of <br/> Summer Camp!</span></h2>
        
        <div className="grid grid-flow-col gap-5 text-center auto-cols-max">
      <div className="flex  text-white flex-col p-2 bg-[#EEAD2E] rounded-box ">
      ...
      <div className="flex flex-col p-2 bg-[#EEAD2E] rounded-box text-white">
