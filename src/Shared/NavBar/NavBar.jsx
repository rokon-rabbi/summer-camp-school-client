  ...
  return (
    <>
      <nav className="md:flex bg-slate-950 md:bg-opacity-80 backdrop-filter backdrop-blur-xm  md:fixed md:w-full z-50 top-0  p-4 md:px-20 md:justify-between   items-center ">
        ...
        <ul
          className={` bg-slate-900 md:bg-opacity-0  shadow-2xl md:shadow-none  md:border-none border z-10  rounded-r-md px-6 py-2 pb-16 md:pb-0 md:space-x-10 md:flex md:static md:text-lg  absolute  text-slate-950 duration-300 ${
        ...
        {user ? (
          <div className="flex items-center  gap-5">
            ...
            <button
              ...
              className="hidden md:block text-white  border-sky-500 px-4 hover:bg-white py-1 border-2 rounded-full hover:text-sky-600 font-bold md:text-lg  "
            >
              logout
        ...
        <div className="flex right-11 relative md:hidden ">
          {user ? (
            ...
            <Link
              to={"/login"}
              className="left-10  text-white  hover:text-sky-600  border-sky-500 px-auto hover:bg-white  py-auto border-2 rounded-full  ml-auto relative md:w-100 w-20 bottom-10 font-bold text-sm md:md:text-lg   p-1"
            >
