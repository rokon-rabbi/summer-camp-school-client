    ...
    <>
      <div className=" bg-zinc-950 md:h-100 relative h-full  ">
        <div
          ...
          style={{
            backgroundImage: `url("https://png.pngtree.com/background/20210711/original/pngtree-simple-outdoor-summer-camp-background-material-picture-image_1089632.jpg")`,
            opacity: "0.09",
          }}
        ></div>
        <div className="  relative md:h-96  md:px-20 grid md:grid-cols-12 px-14 py-5 md:py-14">
          <div className="col-span-4 grid md:justify-between ">
            <img src={Logo} className="mx-auto md:w-44 w-20" alt="" />
          ...
          <div className="col-span-4 p-2 md:p-0  grid justify-between">
          ...
          <div className="col-span-4 p-2 md:p-0 h-40 grid justify-between">
